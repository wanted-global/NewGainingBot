...
▪️قم بزيادة اعضاء لقناتك وزيادة متابعيك

⚙️|انشئ رابطك وقم بالأشتراك بالقنوات
...
⚠️ في حال كنت قد غادرت احدى القنوات الي اخذت نقاط مقابل الانضمام فيها يتم خصم نقاط منك ولن تتمكن من التجميع ايضاً,

- مشاركة الرابط = 1 نقطة 💰: يعطيك 1 مقابل كل شخص جديد يدخل البوت من خلال رابطك.


بعد ان تقوم بجمع ع الاقل 10 نقطة اضغط على ( تمويل قناتك 📣 )
 يتم تحويل النقاط الى اعضاء بهذا المقياس :
 2 = 1 👤
 20 = 10 👤
بعد ان تقوم بطلب الاعضاء 👤 سيتم اضافة قناتك في  ( الأشتراك بالقنوات ),
...
elseif($data=="takecoinn" ){
  bot('editmessagetext',[
       ...
       'message_id'=>$messageid,
                 'text'=>"▪️حسنا ♥️.
▪️ماذا تريد ان تفعل الان .؟
-",
                 'reply_markup'=>json_encode([
                     'inline_keyboard'=>[
  				   [
  				   ['text'=>"الأشتراك بالقنوات",'callback_data'=>"takecoin"],['text'=>"مشاركة الرابط",'callback_data'=>'member']
  				   ],
             [
...
▪️كل اشتراك بلقناة تحصل على نقطة واحدة
▪️اذا قمت بمغادرة قناة فان يتم خصم 2 نقاط من كل قناة تغادرها
▪️عند اضافة قناة غير اخلاقية يتم حذفها وحضرك من استخدام البوت

▫️ملاحضة :- اذا كانت لديك مشكلة مع قناة او عند ضهور قناة احترافية
عليك التبليغ من خلال كلمة الدعم ويم حذفها مباشرآ .

 اصغط الان على بدء التجميع ☑️",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
...
bot('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"▪️عزيزي اشترك بلقناة الرئيسية ( - )
...
يرجى المحاولة مرة اخرة .
اضغط على تحديث او رجوع ↪️❗️",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
...
bot('answercallbackquery', [
           'callback_query_id' =>$membercall,
           'text' => "شكرا لاشتراكك بلقناة ♥️،
تم اضافة النقطة الى نقاطك :
...
-",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                     ...
                     [['text'=>"احصائيات قنواتك",'callback_data'=>'#']],
...
bot('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
	'text'=>"لسته القنوات قمت بتمويلها 📻 !
-",
...
$coin = $cuser["userfild"]["$fromid"]["coin"];
		bot('sendMessage',[
	'chat_id'=>$chatid,
	'text'=>"بوت زيادة اعضاء القناة 💰

▪️زيادة اعضاء قناتك حقيقي (100%)
▪️ضمان عدم مغادرة الاعضاء لقناتك
▪️اشترك بلبوت واستمتع الان ..

زيادة لبوتك مضمونة و حقيقة تصل الى ٥٠٠ عضو 📻❗️

انضم من خلال الاشتراك بلرابط ~>
...
$sendcoinplus = $coinuser + $textmassage;
	bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم ارسال النقاط ( $textmassage ) بنجاح ☑️💰
...
قام ( @$username ) .
بتحويل نقاط اليك قدرها ( $textmassage ) 💰.
-",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
...
يجب ان تطلب اعضاء اقل او يساوي عدد النقاط ❗️",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
...
'text'=>"لوحة تحكم الادمنية 🌐",
        ...
        [['text'=>"اذاعة للقنوات",'callback_data'=>'admin_sendch'],['text'=>"اذاعة نقاط",'callback_data'=>'admin_bcconmem']],
        ...
        [['text'=>"عمل هدية 🎁",'callback_data'=>'admin_code'],['text'=>"ارسال نقاط 🆒",'callback_data'=>'admin_bccon']],
...
$id = $juser["idforsend"];
         bot('sendmessage',[
        	'chat_id'=>$chat_id,
        	'text'=>"تم ارسال [$textmassage] الى العضو [$id] بنجاح 💰✅",
	  'reply_to_message_id'=>$message_id,
    'reply_markup'=>json_encode([
  'inline_keyboard'=>[
[
['text'=>"رجوع ↪️",'callback_data'=>'paneladmin']
          ...
          bot('sendmessage',[
        	'chat_id'=>$id,
        	'text'=>"تم ارسال لك $textmassage نقطه هدية من البوت 💰
...
'caption'=>"النسخة الأحتياطيه 📦"
 ]);
bot('sendmessage',[
          'chat_id'=>$chatid,
          'text'=>"تم ارسال النسخة الاحتياطية بنجاح 🗂✅",
...
bot('sendmessage',[
          'chat_id'=>$chat_id,
          'text'=>"تم ارسال [$textmassage] نقطة لكل الاعضاء [$all] بنجاح ✅",
    'reply_to_message_id'=>$message_id,
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
  [
...
for($z = 0;$z <= count($numbers)-1;$z++){
   ...
   bot('sendmessage',[
          'chat_id'=>$numbers[$z],
		  'text'=>"تم اعطائك [$textmassage] نقاط هدية من البوت 💰
...
▪️عند استخدام الازرار وارسال ( /start )
▪️للاستفسار وشراء نقاط راسلنا : @RSAIED",
	  	]);
}
if($textmassage=="/wow"){
